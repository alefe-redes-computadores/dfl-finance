...
// 🔥 MENU ITEM – MAIS COMPACTO E HORIZONTAL
function MenuItem({
  iconName,
  label,
  href,
  ...
  const content = (
    <div
      className={`group w-full flex items-center gap-3 rounded-[18px] px-3 py-3 transition-all active:scale-[0.98] ${
        disabled
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-[14px] font-semibold text-gray-800 dark:text-gray-200 truncate">
          {label}
        </p>
        {disabled && (
      ...
      <div className="flex items-center gap-2 shrink-0">
        {badge && (
          <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400">
            {badge}
          </span>
        )}
        {disabled ? (
          ...
          <ChevronRight size={16} className="text-gray-300 dark:text-gray-500 transition-transform group-hover:translate-x-0.5" />
        )}
      </div>
    </div>
  )
...
// 🔥 MODAL DE CONFIGURAÇÕES RÁPIDAS (mantido)
...
function ExportModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-6 bg-black/50 backdrop-blur-sm" onClick={() => !exporting && onClose()}>
      <div className="bg-white dark:bg-slate-800 p-6 rounded-t-[32px] sm:rounded-3xl w-full max-w-sm shadow-2xl animate-in slide-in-from-bottom-10 duration-300" onClick={(e) => e.stopPropagation()}>
    ...
    <div className="max-w-md mx-auto min-h-screen bg-[#f8f9fa] dark:bg-slate-900 pb-28 font-sans transition-colors duration-300">
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded-[24px] flex items-center gap-4 shadow-sm border border-gray-200/70 dark:border-slate-700 animate-in fade-in duration-300">
            <div className="relative w-[56px] h-[56px] shrink-0 group">
              <img
                ...
                className={`w-full h-full rounded-[18px] object-cover shadow-sm transition-all ${
                  uploading ? 'opacity-50' : 'opacity-100 group-hover:scale-[1.02]'
                }`}
                alt="Perfil"
              />
              ...
              {isEditing ? (
                <div className="flex items-center gap-2 mb-1">
                  <input
                    ...
                    className="bg-gray-100 dark:bg-slate-700 dark:text-gray-200 px-3 py-2 rounded-[14px] text-[14px] w-full outline-none font-semibold focus:ring-2 focus:ring-teal-500/20"
                    autoFocus
                  />
                  <button
                    type="button"
                    onClick={saveName}
                    className="h-10 w-10 bg-teal-600 text-white rounded-[14px] shadow-sm active:scale-[0.98] transition-transform flex items-center justify-center"
                  >
                    <Check size={16} />
                  </button>
                </div>
                ...
                <div className="flex items-center gap-2 mb-0.5">
                  <h2 className="font-semibold text-[15px] text-gray-800 dark:text-gray-100 truncate">
                    {name || 'Usuário'}
                  </h2>
                  {!isGoogleLogin && (
                    <button
                      ...
                      className="text-gray-400 dark:text-gray-500 hover:text-teal-600 transition-colors flex-shrink-0"
                    >
                      <Edit2 size={12} />
                    </button>
                  )}
            ...
            <button
              ...
              className="w-10 h-10 rounded-[14px] border border-gray-200/70 dark:border-slate-700 bg-gray-50 dark:bg-slate-700/50 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors active:scale-[0.98] shrink-0"
            >
              <Settings size={18} />
            </button>
          </div>
      ...
      <div className="px-4 mt-6 mb-8">
        <button
          ...
          className="w-full flex items-center justify-between rounded-[24px] border border-red-200/60 dark:border-red-900/40 bg-white dark:bg-slate-800 px-4 py-3.5 text-left shadow-sm hover:bg-red-50 dark:hover:bg-red-900/20 active:scale-[0.98] transition-all"
        >
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-[14px] font-semibold text-red-500 dark:text-red-400">
                Sair do aplicativo
              </p>
      ...
      <div className="text-center pb-8 opacity-80 px-4">
        ...
        <p className="text-[11px] text-gray-400 dark:text-gray-500 mt-1">
          Desenvolvido com ♥ por <span className="font-semibold text-teal-600 dark:text-teal-400">Álefe Jôhsefe</span>
        </p>
      </div>
