...
function HomeContent() {
  ...
  const renderSection = (sectionId: string) => {
    switch (sectionId) {
      case 'balance':
        return (
          <SortableSection id="balance" key="balance">
            <div className="bg-white dark:bg-slate-800 rounded-b-[24px] p-6 shadow-sm border border-gray-50 dark:border-slate-700 text-center">
      ...
      case 'income-expense':
        return (
          <SortableSection id="income-expense" key="income-expense">
      ...
      case 'next-card':
        ...
        return (
          <SortableSection id="next-card" key="next-card">
            <div onClick={() => router.push(`/cards/${nextCard.id}`)} className="bg-white dark:bg-slate-800 rounded-b-[20px] p-4 shadow-sm border border-gray-50 dark:border-slate-700 cursor-pointer hover:shadow-md transition-shadow">
      ...
      case 'pendings':
        return (
          <SortableSection id="pendings" key="pendings">
            <div className="bg-white dark:bg-slate-800 rounded-b-[16px] p-3 shadow-sm border border-gray-50 dark:border-slate-700">
      ...
      case 'receivables':
        ...
        return (
          <SortableSection id="receivables" key="receivables">
            <div className="bg-white dark:bg-slate-800 rounded-b-[24px] shadow-sm border border-gray-50 dark:border-slate-700 overflow-hidden p-2">
      ...
      case 'financings':
        ...
        return (
          <SortableSection id="financings" key="financings">
            <div className="bg-white dark:bg-slate-800 rounded-b-[24px] shadow-sm border border-gray-50 dark:border-slate-700 overflow-hidden p-2">
      ...
      case 'budgets':
        ...
        return (
          <SortableSection id="budgets" key="budgets">
            <div className="bg-white dark:bg-slate-800 rounded-b-[24px] shadow-sm border border-gray-50 dark:border-slate-700 overflow-hidden p-2">
      ...
      case 'accounts':
        return (
          <SortableSection id="accounts" key="accounts">
            <div className="bg-white dark:bg-slate-800 rounded-b-[24px] shadow-sm border border-gray-50 dark:border-slate-700 overflow-hidden p-2">
      ...
      case 'cards':
        return (
          <SortableSection id="cards" key="cards">
            <div className="bg-white dark:bg-slate-800 rounded-b-[24px] shadow-sm border border-gray-50 dark:border-slate-700 overflow-hidden p-2">
      ...
      case 'recent':
        return (
          <SortableSection id="recent" key="recent">
            <div className="bg-white dark:bg-slate-800 rounded-b-[24px] shadow-sm border border-gray-50 dark:border-slate-700 overflow-hidden py-2">
