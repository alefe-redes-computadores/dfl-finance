...
function HomeContent() {
  ...
  return (
    <div ref={containerRef} className="relative mx-auto min-h-[100dvh] w-full max-w-2xl bg-gray-50 px-4 pb-28 pt-3 font-sans transition-colors duration-300 dark:bg-slate-900">
