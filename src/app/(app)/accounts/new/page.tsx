...
import { ArrowLeft, Save, X, Wallet, Building2, CreditCard, PiggyBank } from "lucide-react"
...
function AccountFormContent() {
  ...
  const editId = searchParams.get("edit") // ✅ usa "edit" para edição
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editId) {
        // ✅ EDIÇÃO: atualiza conta existente
  ...
  // Exibe skeleton enquanto carrega dados para edição
