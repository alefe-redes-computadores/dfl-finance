...
export default function AccountStatementPage() {
  ...
  const [showTransfer, setShowTransfer] = useState(false) // Gatilho novo
  const [showBalance, setShowBalance] = useState(false)   // Gatilho novo
    ...
    <div className="max-w-md mx-auto min-h-screen bg-gray-50 pb-20 font-sans relative">
      ...
      <div className="flex justify-between items-center p-4 bg-white">
        ...
        <div className="flex items-center gap-4 text-gray-700">
          ...
          <button onClick={() => setShowBalance(true)}><Scale size={20} /></button>
