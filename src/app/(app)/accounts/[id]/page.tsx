...
import { ChevronLeft, Edit2, ArrowRightLeft, Scale, ChevronRight } from 'lucide-react'
...
export default function AccountStatementPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    // 2. Busca as transações do mês para esta conta
    ...
    // Calcula Entradas e Saídas do mês
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-gray-50 pb-20 font-sans">
      ...
      <div className="bg-white px-4 pb-6 flex flex-col items-center border-b border-gray-100 shadow-sm">
        <div 
          className="w-16 h-16 rounded-2xl flex items-center justify-center text-xl font-bold text-white mb-3 shadow-md"
