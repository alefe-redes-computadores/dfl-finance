      ...
      <div className="mx-auto w-full max-w-md px-4 pt-4">
        ...
        <div className="mb-4 flex items-start justify-between gap-3">
          ...
          <button
            type="button"
            onClick={() => router.push('/budgets')}
            className="shrink-0 rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-[13px] font-bold text-slate-700 shadow-sm transition-all active:scale-[0.98] dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
          >
            Voltar
          </button>
        </div>
