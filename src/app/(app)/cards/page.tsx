...
import { ChevronLeft, Plus, CreditCard, Loader2, Edit3 } from 'lucide-react'
      ...
      <div className="px-4 space-y-3">
        {loading ? (
          ...
          cards.map((card) => (
            ...
            >
              {/* Área clicável: vai para detalhes */}
              <div
