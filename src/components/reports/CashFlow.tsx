  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-gray-50 dark:border-slate-700">
        <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200 mb-4">Evolução Diária</h3>
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-400 text-sm py-10">Nenhuma transação encontrada neste período.</p>
        ) : (
