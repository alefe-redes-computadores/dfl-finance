...
export function SyncStatusModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    // O 'fixed inset-0' garante que ele cubra a tela toda e centralize o conteúdo
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      {/* Backdrop Translúcido (o efeito de "vidro" bonito) */}
      <div 
        className="absolute inset-0 bg-black/40 backdrop-blur-sm" 
        onClick={onClose} 
      />
      
      {/* Modal - Centralizado, com o design arredondado padrão */}
      <div className="relative z-10 w-full max-w-sm bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-2xl border border-gray-200 dark:border-slate-700 animate-in fade-in zoom-in duration-200">
