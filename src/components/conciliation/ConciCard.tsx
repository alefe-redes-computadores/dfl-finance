...
import { Check, X, Calendar, DollarSign, Tag, ArrowUp, ArrowDown } from 'lucide-react'
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 text-sm">
            ...
            {transaction.accountSuggestion && (
              <div className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-full text-blue-700 dark:text-blue-300">
                <DollarSign size={14} />
                <span className="font-medium">{transaction.accountSuggestion}</span>
              </div>
            )}
          </div>
