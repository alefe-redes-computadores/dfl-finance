...
export default function Toast({ message, type, onClose }: ToastProps) {
  ...
  return (
    <div
      className={`pointer-events-auto flex items-center gap-3 px-4 py-3 min-w-[280px] max-w-sm mx-auto rounded-full shadow-2xl backdrop-blur-md border transition-all duration-[250ms] ease-out bg-white/90 dark:bg-slate-800/90 dark:border-slate-700/50 ${
